...
require_once('./php_class/ClientProfileManagement.php');
    ...
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "John Smith", "122 Green Rd", "244 Blue St", "Houston", "Texas", "77201");
    ...
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "John Smith", "122 Green Rd", "244 Blue St", "Houston", "Texas", "77201");
        $this->assertSame($cpmTester -> getState(), "Texas");
    }
    ...
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "", "122 Green Rd", "244 Blue St", "Houston", "Texas", "77201");
        $this->assertSame($cpmTester -> getName(), null);
    }
    public function testCPMEmptyParamAdd1(): void
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "John Smith", "", "244 Blue St", "Houston", "Texas", "77201");
        $this->assertSame($cpmTester -> getAdd1(), null);
    }
    public function testCPMEmptyParamAdd2(): void
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "John Smith", "122 Green Rd", "", "Houston", "Texas", "77201");
        $this->assertSame($cpmTester -> getAdd2(), "");
    }
    public function testCPMEmptyParamCity(): void
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "John Smith", "122 Green Rd", "244 Blue St", "", "Texas", "77201");
    ...
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "John Smith", "122 Green Rd", "244 Blue St", "Houston", "Texas", "");
    ...
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "Johnathan L Welmsworth Jackson Livingston Martin Fransic", "122 Green Rd", "244 Blue St", "Houston", "Texas", "77201");
        $this->assertSame($cpmTester -> getName(), null);
    }
    public function testCPMLongParamAdd1(): void
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "John Smith", "5865241514512478954325411 Jean Baptiste Point du Sable Lake Shore Drive Street Road Ditch Sidewalk Path Alley", "244 Blue St", "Houston", "Texas", "77201");
        $this->assertSame($cpmTester -> getAdd1(), null);
    }
    public function testCPMLongParamAdd2(): void
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "John Smith", "122 Green Rd", "5865241514512478954325411 Jean Baptiste Point du Sable Lake Shore Drive Street Road Ditch Sidewalk Path Alley", "Houston", "Texas", "77201");
        $this->assertSame($cpmTester -> getAdd2(), null);
    }
    public function testCPMLongParamZipcode(): void
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "John Smith", "122 Green Rd", "244 Blue St", "Houston", "Texas", "77201-55623");
        $this->assertSame($cpmTester -> getZipcode(), null);
    }
    public function testCPMShortParamZipcode(): void
    {
        $cpmTester = new ClientProfileManagement("cooldude9!", "John Smith", "122 Green Rd", "244 Blue St", "Houston", "Texas", "7720");
        $this->assertSame($cpmTester -> getZipcode(), null);
    }
}
?>
